...
gateway = braintree.BraintreeGateway(
    braintree.Configuration(
            ...
            merchant_id="z9njwv488pg2xwzz",
            public_key="snd8wpjqz8348y3x",
            private_key="a9d84d514e574436f946000bf7f138d2"       
    )
)
...
def generate_token(request, id, token):
    if not validate_user_session(id, token):
        return JsonResponse({"error": "Invaild Session, Please login again"})
